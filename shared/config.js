...
const VENUEWISE_CONFIG = {
  ...
  platforms: [
    ...
    },
    {
      ...
      url:         'https://venuewise.net/homehuddle/organizationhuddle',
      color:       '#7C3AED',
      icon:        '🏢',
      ctaLabel:    'Request Demo',
      ctaUrl:      'https://venuewise.net/homehuddle/organizationhuddle',
    },
    {
      id:          'facilityhuddle',
      name:        'FacilityHuddle',
      tagline:     'Facility promotion and open-slot visibility.',
      url:         'https://venuewise.net/homehuddle/facilityhuddle',
      color:       '#DC2626',
      icon:        '🏟️',
      ctaLabel:    'Promote Your Facility',
      ctaUrl:      'https://venuewise.net/homehuddle/facilityhuddle',
    },
    {
      id:          '5starsportsmedia',
